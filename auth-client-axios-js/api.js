...
const AuthoritiesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        deleteAuthorities: (requestBody, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getAuthorities: (id, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/v1/authorities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        setAuthorities: (authority, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
const AuthoritiesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteAuthorities(requestBody, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.deleteAuthorities(requestBody, clientId, options);
         ...
         * @throws {RequiredError}
         */
        getAuthorities(id, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getAuthorities(id, clientId, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        setAuthorities(authority, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.setAuthorities(authority, clientId, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class AuthoritiesApi extends base_1.BaseAPI {
     ...
     */
    deleteAuthorities(requestBody, clientId, options) {
        return exports.AuthoritiesApiFp(this.configuration).deleteAuthorities(requestBody, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_CLIENT 权限。
     * @summary 删除应用权限
     ...
     */
    getAuthorities(id, clientId, options) {
        return exports.AuthoritiesApiFp(this.configuration).getAuthorities(id, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 READ_CLIENT 权限。
     * @summary 获取应用权限
     ...
     */
    setAuthorities(authority, clientId, options) {
        return exports.AuthoritiesApiFp(this.configuration).setAuthorities(authority, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_CLIENT 权限。
     * @summary 添加应用权限
...
const RolesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteRoles: (id, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        deleteUserClientRoles: (uid, cid, id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'uid' is not null or undefined
            common_1.assertParamExists('deleteUserClientRoles', 'uid', uid);
            // verify required parameter 'cid' is not null or undefined
            common_1.assertParamExists('deleteUserClientRoles', 'cid', cid);
            // verify required parameter 'id' is not null or undefined
            common_1.assertParamExists('deleteUserClientRoles', 'id', id);
         ...
         * @throws {RequiredError}
         */
        getRoles: (id, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/v1/roles`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getUserClientRoles: (uid, cid, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'uid' is not null or undefined
            common_1.assertParamExists('getUserClientRoles', 'uid', uid);
            // verify required parameter 'cid' is not null or undefined
            common_1.assertParamExists('getUserClientRoles', 'cid', cid);
            const localVarPath = `/v1/users/{uid}/clients/{cid}/roles`
                .replace(`{${"uid"}}`, encodeURIComponent(String(uid)))
                .replace(`{${"cid"}}`, encodeURIComponent(String(cid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        getUserRoleClients: (uid, managed, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'uid' is not null or undefined
            common_1.assertParamExists('getUserRoleClients', 'uid', uid);
         ...
         * @throws {RequiredError}
         */
        setRoles: (role, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        setUserClientRoles: (uid, cid, userRole, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'uid' is not null or undefined
            common_1.assertParamExists('setUserClientRoles', 'uid', uid);
            // verify required parameter 'cid' is not null or undefined
            common_1.assertParamExists('setUserClientRoles', 'cid', cid);
            // verify required parameter 'userRole' is not null or undefined
            common_1.assertParamExists('setUserClientRoles', 'userRole', userRole);
            const localVarPath = `/v1/users/{uid}/clients/{cid}/roles`
                .replace(`{${"uid"}}`, encodeURIComponent(String(uid)))
                .replace(`{${"cid"}}`, encodeURIComponent(String(cid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
const RolesApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteRoles(id, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.deleteRoles(id, clientId, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        deleteUserClientRoles(uid, cid, id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.deleteUserClientRoles(uid, cid, id, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getRoles(id, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getRoles(id, clientId, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getUserClientRoles(uid, cid, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getUserClientRoles(uid, cid, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getUserRoleClients(uid, managed, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getUserRoleClients(uid, managed, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        setRoles(role, clientId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.setRoles(role, clientId, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        setUserClientRoles(uid, cid, userRole, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.setUserClientRoles(uid, cid, userRole, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class RolesApi extends base_1.BaseAPI {
     ...
     */
    deleteRoles(id, clientId, options) {
        return exports.RolesApiFp(this.configuration).deleteRoles(id, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_USER 权限。
     * @summary 删除用户的角色
     ...
     */
    deleteUserClientRoles(uid, cid, id, options) {
        return exports.RolesApiFp(this.configuration).deleteUserClientRoles(uid, cid, id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_USER 权限。
     * @summary 删除用户的角色
     ...
     */
    getRoles(id, clientId, options) {
        return exports.RolesApiFp(this.configuration).getRoles(id, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用需要 READ_USER 权限。
     * @summary 获取用户角色
     ...
     */
    getUserClientRoles(uid, cid, options) {
        return exports.RolesApiFp(this.configuration).getUserClientRoles(uid, cid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用需要 READ_USER 权限。
     * @summary 获取用户的角色应用
     ...
     */
    getUserRoleClients(uid, managed, options) {
        return exports.RolesApiFp(this.configuration).getUserRoleClients(uid, managed, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户（uid 为当前用户除外）需要 READ_USER 权限。
     * @summary 获取用户角色
     ...
     */
    setRoles(role, clientId, options) {
        return exports.RolesApiFp(this.configuration).setRoles(role, clientId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_USER 权限。
     * @summary 为用户添加角色
     ...
     */
    setUserClientRoles(uid, cid, userRole, options) {
        return exports.RolesApiFp(this.configuration).setUserClientRoles(uid, cid, userRole, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 应用和用户需要 GRANT_USER 权限。
     * @summary 为用户添加角色
