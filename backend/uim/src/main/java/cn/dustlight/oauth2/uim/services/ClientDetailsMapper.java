...
import cn.dustlight.oauth2.uim.models.ClientDetails.ClientScope;
import cn.dustlight.oauth2.uim.models.ClientDetails;
import cn.dustlight.oauth2.uim.models.GrantType;
...
public interface ClientDetailsMapper {
    ...
    @Results(id = "ClientDetails", value = {
            ...
            @Result(property = "resourceIds", column = "client_id", many = @Many(select = "cn.dustlight.oauth2.uim.services.ResourceDetailsMapper.getClientResourceIdsByClientId")),
            @Result(property = "scope", column = "client_id", many = @Many(select = "cn.dustlight.oauth2.uim.services.ClientDetailsMapper.getClientScopeByClientId")),
            @Result(property = "authorizedGrantTypes", column = "client_id", many = @Many(select = "cn.dustlight.oauth2.uim.services.ClientDetailsMapper.getClientGrantTypesByClientId")),
            @Result(property = "authorities", column = "client_id", many = @Many(select = "cn.dustlight.oauth2.uim.services.AuthorityDetailsMapper.getAuthoritiesByClientId")),
