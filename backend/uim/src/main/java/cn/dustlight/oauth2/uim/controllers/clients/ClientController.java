...
public interface ClientController {
    ...
    @PreAuthorize("#user.matchUid(#uid) and hasAuthority('WRITE_CLIENT')")
    void removeClient(@PathVariable("uid") Long uid,
                      @PathVariable("cid") String cid);

    @Operation(summary = "创建用户应用")
