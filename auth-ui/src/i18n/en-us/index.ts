...
export default {
  ...
  "SystemSettings": {
    ...
    "deleteGrantTypeMsg": "Are you sure to delete the authorization grant type?",
    "createGrantType": "Create Grant Type",
    "createGrantTypeMsg": "Please enter the name of the authorization grant type.",
    "scopes": "Authorization Scopes",
    "scopesDesc": "Manage the OAuth2 authorization scopes.",
    "deleteScope": "Delete Scope",
    "deleteScopeMsg": "Are you sure to delete the authorization scope?",
    "createScope": "Create Scope",
    "createScopeMsg": "Please enter the name of the authorization scope.",
    "authorities": "Authorities",
    "authoritiesDesc": "Management system authorities.",
    "deleteAuthority": "Delete Authority",
    "deleteAuthorityMsg": "Are you sure to delete the authority?",
    "createAuthority": "Create Authority",
    "createAuthorityMsg": "Please enter the name of the authority.",
    "roles": "Roles",
