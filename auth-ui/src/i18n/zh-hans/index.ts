...
export default {
  ...
  "ResetPasswordByPhone": {
    ...
    "step1": {
      "title": "输入您的手机号码",
      "caption": "请输入您的手机号码，用于接收验证码。",
      "phone": "手机号码",
      "phoneHint": "您的手机号码，用于接收验证码。",
      "phoneRule": "请输入带有国际区号的有效手机号码。",
      "phoneNotExists": "该号码未绑定任何账号。"
    },
    "step2": {
      "title": "设置密码",
      "caption": "设置您的新密码。",
