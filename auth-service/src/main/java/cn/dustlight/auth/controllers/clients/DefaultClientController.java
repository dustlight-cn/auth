...
public class DefaultClientController implements ClientController {
    ...
    @Override
    public QueryResults<? extends Client> getClients(String keywords, Collection<String> order, Integer offset, Integer limit) {
    ...
    @Override
    public QueryResults<? extends Client> getClients(Long uid, String keywords, Collection<String> order, Integer offset, Integer limit) {
        if (keywords == null || keywords.length() == 0)
