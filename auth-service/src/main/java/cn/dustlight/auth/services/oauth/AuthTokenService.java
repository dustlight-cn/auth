...
public class AuthTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        if (this.authenticationManager != null && !authentication.isClientOnly()) {
            ...
            DefaultUser usr = (DefaultUser) user.getPrincipal();
            usr.setRoles(((DefaultUser) authentication.getPrincipal()).getUserRoles());

            user = new PreAuthenticatedAuthenticationToken(usr, user.getCredentials(), usr.getAuthorities());
